#!/bin/bash
wget https://github.com/molgenis/vip-inheritance/releases/download/v0.0.2/genemap-mapper.jar
...
module load Java
java -jar genemap-mapper.jar -i genemap2.txt -h phenotype.hpoa -c CGD.txt.gz -o gene_inheritance_modes_$(date '+%Y%m%d').tsv -f
module purge
