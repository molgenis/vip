...
install_files() {
  ...
  local data=()
  data+=("c6818894b16694df4eb94828bad57891" "images/annotsv-3.5.5.sif" "")
  data+=("945102500cecc5bd2d8881358e6c8790" "images/bcftools-1.23.sif" "")
  data+=("cda632523f686d5a7165fb394d16624c" "images/capice-5.1.2+build.1.sif" "")
  data+=("cad49a9d2c5e489b802887a4d22247b1" "images/cutesv-2.1.3+441433d.sif" "")
  data+=("28937e8a97287c85b030d43e9362fecc" "images/deepvariant-1.10.0.sif" "")
  data+=("bf91f77bd18989d13c2d631a6be09f5a" "images/deepvariant_deeptrio-1.10.0.sif" "")
  ...
  data+=("c645537a5e50c53fd7a97eda83ee34cf" "images/manta-1.6.0+build.1.sif" "")
  ...
  data+=("5125b9e9aed533cef592cc271dcda5bb" "images/samtools-1.23.sif" "")
  data+=("ab68b8a9ddb9419f5c35fc3af93dbc60" "images/seqtk-1.5.sif" "")
  data+=("31dfde07fdbdd477835730bfaeea55c3" "images/spectre-0.2.1+9058094.sif" "")
  data+=("5872a0d033b9b9655852d0a6125cbddf" "images/straglr-1.5.6+build.1.sif" "")
  data+=("38b3ab915427b73a66d30e4b3aa279b5" "images/straglr-tsv2vcf-1.2.0+build.1.sif" "")
  data+=("36afa1f36b5c8d06797f2e7fdfc15ae4" "images/stranger-0.10.0.sif" "")
  data+=("bf5bf5b13ffa8c1b6e41af921b44b82f" "images/vcf-decision-tree-6.0.0+build.1.sif" "")
  data+=("a94e640750dab26ac6541b972a3cf5a8" "images/vcf-inheritance-matcher-4.0.0+build.1.sif" "")
  data+=("51745bdacf2ff94e50dd46dcf9232c95" "images/vcf-report-8.2.0+build.1.sif" "")
  data+=("77e5fe4baa56cbfa113f5d86b6fcd493" "images/vep-115.2.sif" "")
