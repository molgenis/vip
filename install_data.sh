...
install_files() {
  ...
  local data=()
  data+=("cd943f56552e1ce5e8c7013218d111e9" "images/annotsv-3.5.5+build.1.sif" "")
  data+=("d2cf2210cfdc113dd390faceea468fd4" "images/bcftools-1.23.1.sif" "")
  ...
  data+=("bf5bf5b13ffa8c1b6e41af921b44b82f" "images/vcf-decision-tree-6.0.2.sif" "")
  data+=("a94e640750dab26ac6541b972a3cf5a8" "images/vcf-inheritance-matcher-4.0.1.sif" "")
  data+=("c6d9342a8eef9a036bda398b11c4b2b1" "images/vcf-report-8.2.2.sif" "")
