...
install_files() {
  ...
  data+=("FIXME" "images/vcf-decision-tree-6.0.0.sif" "")
  data+=("FIXME" "images/vcf-inheritance-matcher-4.0.0.sif" "")
  ...
  data+=("d89255eb1c69ab7db5e156f2ca969637" "resources/vip-report-template-v8.0.1.html" "")
