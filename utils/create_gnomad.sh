...
CMD_BCFTOOLS="apptainer exec --no-mount home ${APPTAINER_CACHEDIR}/bcftools-1.23.sif bcftools"
CMD_BGZIP="apptainer exec --no-mount home ${APPTAINER_CACHEDIR}/vep-115.2+d7cffe1.sif bgzip"
CMD_TABIX="apptainer exec --no-mount home ${APPTAINER_CACHEDIR}/vep-115.2+d7cffe1.sif tabix"
