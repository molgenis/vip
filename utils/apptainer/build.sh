...
main() {
  ...
  images+=("gado-1.0.3-jdk25")
  images+=("manta-1.6.0")
  images+=("minimap2-2.27_v2")
  images+=("picard-3.1.1-jdk25")
  images+=("samtools-1.17-patch1")
  images+=("seqtk-1.4_v2")
  images+=("spectre-0.2.1-patched_v2")
  images+=("stranger-0.9.3")
  images+=("straglr-1.5.6")
  images+=("straglr-tsv2vcf-1.0.0")
  images+=("vcf-decision-tree-6.0.0-jdk25")
  images+=("vcf-inheritance-matcher-4.0.0-jdk25")
  images+=("vcf-report-8.0.2-jdk25")
  images+=("whatshap-2.4")
