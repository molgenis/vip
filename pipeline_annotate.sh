...
executeCapice() {
  ...
  singularity exec --bind "/apps,/groups,${TMPDIR},/home/umcg-dhendriksen/git/capice:/mycapice" "/home/umcg-dhendriksen/git/vip/singularity/CAPICE.sif" python /mycapice/capice.py -vv predict -i "${tmpOutputPath2}" -m /mycapice/CAPICE_model/GRCh37/POC/xgb_booster_poc.pickle.dat -o "$(dirname "${outputFilePath}")/test.tsv"
}
