...
def validate(samples){
  ...
  samples.each{ sample ->
    if(sample.paternal_id != null){
      if(sample.individual_id == sample.paternal_id) exit 1, "individual_id '${sample.individual_id}' cannot be the same as paternal_id '${sample.paternal_id}'"
    ...
    if(sample.maternal_id != null){
      if(sample.individual_id == sample.maternal_id) exit 1, "individual_id '${sample.individual_id}' cannot be the same as maternal_id '${sample.maternal_id}'"
    ...
    if(sample.paternal_id != null && sample.maternal_id != null){
      if(sample.paternal_id == sample.maternal_id) exit 1, "paternal_id '${sample.paternal_id}' cannot be the same as maternal_id '${sample.maternal_id}'"
    }
  }
}
