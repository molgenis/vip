...
args=()
args+=("--workflow" "vcf")
args+=("--config" "${TEST_RESOURCES_DIR}/mtdna_plp.cfg")
args+=("--output" "${OUTPUT_DIR}")
args+=("--resume")

runVip "${args}" "${TEST_RESOURCES_DIR}/mtdna_plp.tsv"

runSompy "${TEST_RESOURCES_DIR}/mtdna_plp.vcf" "${OUTPUT_DIR}/vip.vcf.gz"
