...
download "${base_url}/m54238_180628_014238_s0_10000.Q20.adaptive_sampling_adaptive01.csv" "f07bde8101bdff8a27b1cb5d6fb03a3b"

args=()
args+=("--workflow" "fastq")
args+=("--config" "${TEST_RESOURCES_DIR}/nanopore_adaptive_sampling_adaptive01.cfg")
args+=("--output" "${OUTPUT_DIR}")
args+=("--resume")

runVip "${args}" "${TEST_RESOURCES_DIR}/nanopore_adaptive_sampling_adaptive01.tsv"
