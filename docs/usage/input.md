...
<sup>3</sup> `stop_receiving` when [MinKnow](https://nanoporetech.com/document/experiment-companion-minknow) software version 25 or lower was used, `sequence` for MinKnow 26 and above.
