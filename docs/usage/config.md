...
| vcf.annotate.GRCh38.vep_plugin_green_db_enabled | false       | description: enabling is only allowed for academic use, for details see [here](https://doi.org/10.5281/zenodo.5636209)                                                                                                                                      |
