...
| snv.glnexus.WES.preset                      | DeepVariantWES | for details, see [here](https://github.com/dnanexus-rnd/GLnexus/). allowed values: [DeepVariant, DeepVariantWES, DeepVariantWGS, DeepVariant_unfiltered] |
| snv.glnexus.WGS.preset                      | DeepVariantWGS | for details, see [here](https://github.com/dnanexus-rnd/GLnexus/). allowed values: [DeepVariant, DeepVariantWES, DeepVariantWGS, DeepVariant_unfiltered] |
