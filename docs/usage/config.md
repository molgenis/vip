...
| str.straglr.tsv2vcf.haploid_contigs_male                        | chrX,chrY                                                  | List of contigs of the sex chromosome, this information is needed to correctly determine the genotype of the STR call.                                                                                                                                |
