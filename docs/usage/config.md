...
| GRCh37.reference.haploidContigs                |                                                              | chain file to convert GRCh37 to GRCh38 data                                                                                                                                                                                        |
| GRCh37.reference.parRegionsBed                 |                                                              |                                                                                                                                                                                                                                    |
| GRCh38.reference.haploidContigs                | chrX,chrY                                                    | chromosomes that should be considered haploid for male samples                                                                                                                                                                     |
| GRCh38.reference.parRegionsBed                 | *installed*                                                  | bed file containing the PAR regions                                                                                                                                                                                                | | chain file to convert T2T to GRCh38 data                                                                                                                                                                                           |
