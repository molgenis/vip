...
workflow fastq {
  ...
  main:
    ...
    ch_fastp_paired_end.reads_pass
      | map { meta, fastq_r1, fastq_r2 -> [meta, fastq_r1, fastq_r2, meta.project.regions ? meta.project.regions : meta.project.sequencing_method == "WES" ? params.cram.coverage[params.assembly].default_bed_exon : params.cram.coverage[params.assembly].default_bed_gene]}
