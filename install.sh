...
download_files() {
  ...
  urls+=("8a80c7c7c99757840b27fffae7924c2e" "resources/GRCh38/clinvar_20241126-stripped.tsv.gz")
  urls+=("d8f7ef4667f0685e17e67a79612467f1" "resources/GRCh38/clinvar_20241126-stripped.tsv.gz.tbi")
