...
download_files() {
  ...
  local urls=()
  urls+=("cf78e29e7d79c595abe30db13fff739d" "images/annotsv-3.3.6_v2.sif")
  ...
  urls+=("4b04cdd7fd02616cfaf4bd0ffed1fc8d" "images/gado-1.0.3_v2.sif")
  ...
  urls+=("27eccc5506a7ea872abc3cb61b3ce166" "images/picard-3.1.1_v2.sif")
