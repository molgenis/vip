...
download_resources_molgenis() {
  ...
  files+=("GRCh38/gnomad.total.v4.0.sites.stripped.tsv.gz")
  files+=("GRCh38/gnomad.total.v4.0.sites.stripped.tsv.gz.tbi")
...
download_images() {
  ...
  files+=("vcf-decision-tree-3.9.0.sif")
  files+=("vcf-inheritance-matcher-3.0.1.sif")
  files+=("vcf-report-5.8.0.sif")
  files+=("vep-109.3.sif")
