...
download_files() {
  ...
  urls+=("dfdcdc10ec6106d5bf6d3e02f781de97" "images/gado-1.0.3_v2.sif")
  ...
  urls+=("20254a86969f4421680708ea48cf0987" "images/picard-3.1.1_v2.sif")
  ...
  urls+=("42dd56c8eb20b3e7eff7c2b8b8d12cde" "images/vcf-decision-tree-4.1.3.sif")
  urls+=("b1a919e72c232bd3531d91122af8fe2d" "images/vcf-inheritance-matcher-3.1.1_v2.sif")
