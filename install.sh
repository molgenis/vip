...
download_resources_molgenis() {
  ...
  if [ "${assembly}" == "ALL" ] || [ "${assembly}" == "GRCh37" ]; then
    ...
    files+=("GRCh37/spliceai_scores.masked.indel.hg19.vcf.gz.csi")
    files+=("GRCh37/spliceai_scores.masked.snv.hg19.vcf.gz")
    files+=("GRCh37/spliceai_scores.masked.snv.hg19.vcf.gz.csi")
  ...
  if [ "${assembly}" == "ALL" ] || [ "${assembly}" == "GRCh38" ]; then
    ...
    files+=("GRCh38/spliceai_scores.masked.indel.hg38.vcf.gz.csi")
    files+=("GRCh38/spliceai_scores.masked.snv.hg38.vcf.gz")
    files+=("GRCh38/spliceai_scores.masked.snv.hg38.vcf.gz.csi")
