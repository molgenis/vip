...
download_files() {
  ...
  urls+=("a626257bb751af22c4e6cf940f8b1050" "resources/gado/v1.0.4/HPO_2024_02_12_prediction_matrix.cols.txt.gz")
  urls+=("71d60ff4c56eea92d8ac593e26243927" "resources/gado/v1.0.4/HPO_2024_02_12_prediction_matrix.datg")
  urls+=("335be2939b86edec3934130b7567ae2e" "resources/gado/v1.0.4/HPO_2024_02_12_prediction_matrix.rows.txt.gz")
  urls+=("bcfcc7060f24dda473e35d4f8ce35743" "resources/gado/v1.0.4/hp.obo")
  urls+=("33e5f44edbb31625f153127be83f7640" "resources/gado/v1.0.4/genesProteinCoding.txt")
  urls+=("e2e1b4a10ecf47b1e4fe075a69f89c2e" "resources/gado/v1.0.4/HPO_2024_02_12_prediction_info.txt.gz")
