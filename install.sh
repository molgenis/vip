...
download_files() {
  ...
  urls+=("1b66daab7018f6a5aba061bc34cf6f35" "resources/GRCh38/GRCh38_GREEN-DB.bed.gz")
  urls+=("1b66daab7018f6a5aba061bc34cf6f35" "resources/GRCh38/GRCh38_GREEN-DB.bed.gz.tbi")
