...
download_files() {
  ...
  urls+=("e5a575dcc8be75807732271fa86c1287" "images/mosdepth-0.3.3.sif")
  ...
  urls+=("6264ae40587d8cbebbc65d57315720b1" "images/spectre-0.2.0.sif")
  ...
  urls+=("b01529a38ffe3f3b1a0e5feb5aa23232" "resources/GRCh38/spectre_metadata.mdr")
